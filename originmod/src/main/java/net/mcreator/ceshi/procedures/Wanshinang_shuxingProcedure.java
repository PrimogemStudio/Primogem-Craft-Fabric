		...
		if ((itemstack).getDamageValue() == (itemstack).getMaxDamage()) {
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("primogemcraft:qiwusunhuai066")), SoundSource.PLAYERS, (float) 0.5, (float) 0.5);
				} else {
			...
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(new TextComponent("\u00A75\u300E\u5947\u7269\u300F\u00A7e\u4E07\u8BC6\u56CA\u00A7c\u5DF2\u635F\u574F\uFF01"), (false));
		}
	}
}
