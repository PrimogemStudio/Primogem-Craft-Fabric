		...
		if (entity.getPersistentData().getDouble("mengying") == 1) {
			{
				...
				if (_ist.hurt(520, new Random(), null)) {
					_ist.shrink(1);
			...
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("item.totem.use")), SoundSource.PLAYERS, 1, 1);
				} else {
