...
public class DiguidaimashuxingProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (!itemstack.getOrCreateTag().getBoolean("daima6_yixiufu")) {
			if (!itemstack.getOrCreateTag().getBoolean("daishanchu") && (itemstack).getDamageValue() == 0) {
				...
				if (entity instanceof Player _player && !_player.level.isClientSide())
					_player.displayClientMessage(new TextComponent("\u00A75\u300E\u5947\u7269\u300F\u00A7b\u65E0\u9650\u9012\u5F52\u7684\u4EE3\u7801\u00A7a\u4FEE\u590D\u5B8C\u6210"), (false));
			...
			if (!(entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(PrimogemcraftModMobEffects.DIGUIXIAOGUO.get()) : false)) {
		...
		if (!itemstack.getOrCreateTag().getBoolean("daishanchu") && (itemstack).getDamageValue() == (itemstack).getMaxDamage()) {
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(new TextComponent("\u00A75\u300E\u5947\u7269\u300F\u00A7b\u65E0\u9650\u9012\u5F52\u7684\u4EE3\u7801\u00A7c\u5DF2\u8017\u5C3D\uFF01"), (false));
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
