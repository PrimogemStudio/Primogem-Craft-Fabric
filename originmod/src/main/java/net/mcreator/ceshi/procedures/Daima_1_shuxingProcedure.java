...
public class Daima_1_shuxingProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (entity.getPersistentData().getBoolean("daima1_naijiu")) {
			(itemstack).setDamageValue((int) ((itemstack).getDamageValue() - 1));
			NaijiuxianzhiProcedure.execute(itemstack);
			entity.getPersistentData().putBoolean("daima1_naijiu", (false));
		}
		if (!itemstack.getOrCreateTag().getBoolean("daishanchu") && (itemstack).getDamageValue() == 0) {
			itemstack.getOrCreateTag().putBoolean("daima1_yixiufu", (true));
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(new TextComponent("\u00A75\u300E\u5947\u7269\u300F\u00A7f\u4E71\u4E03\u516B\u7CDF\u7684\u4EE3\u7801\u00A7a\u4FEE\u590D\u5B8C\u6210"), (false));
		...
		if (itemstack.getOrCreateTag().getBoolean("daima1_yixiufu")) {
			if (!(entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(PrimogemcraftModMobEffects.ZHENGCHANGDAIMA.get()) : false)) {
				if (entity instanceof LivingEntity _entity)
					_entity.addEffect(new MobEffectInstance(PrimogemcraftModMobEffects.ZHENGCHANGDAIMA.get(), 1200, 0, (false), (false)));
				{
		...
		if (!itemstack.getOrCreateTag().getBoolean("daishanchu") && (itemstack).getDamageValue() == (itemstack).getMaxDamage()) {
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(new TextComponent("\u00A75\u300E\u5947\u7269\u300F\u00A7f\u4E71\u4E03\u516B\u7CDF\u7684\u4EE3\u7801\u00A7c\u5DF2\u8017\u5C3D\uFF01"), (false));
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
