...
public class MeiyouzhushishuxingProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (!itemstack.getOrCreateTag().getBoolean("daishanchu") && (itemstack).getDamageValue() == 0) {
			itemstack.getOrCreateTag().putBoolean("daima5_yixiufu", (true));
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(new TextComponent("\u00A75\u300E\u5947\u7269\u300F\u00A7d\u6CA1\u6709\u6CE8\u91CA\u7684\u4EE3\u7801\u00A7a\u4FEE\u590D\u5B8C\u6210"), (false));
		...
		if (itemstack.getOrCreateTag().getBoolean("daima5_yixiufu")) {
			if (!(entity instanceof LivingEntity _livEnt ? _livEnt.hasEffect(PrimogemcraftModMobEffects.QUEZHUSHIXIAOGUO.get()) : false)) {
				if (entity instanceof LivingEntity _entity)
					_entity.addEffect(new MobEffectInstance(PrimogemcraftModMobEffects.QUEZHUSHIXIAOGUO.get(), 100, 0, (false), (false)));
				{
		...
		if (!itemstack.getOrCreateTag().getBoolean("daishanchu") && (itemstack).getDamageValue() == (itemstack).getMaxDamage()) {
			if (entity instanceof Player _player && !_player.level.isClientSide())
				_player.displayClientMessage(new TextComponent("\u00A75\u300E\u5947\u7269\u300F\u00A7d\u6CA1\u6709\u6CE8\u91CA\u7684\u4EE3\u7801\u00A7c\u5DF2\u8017\u5C3D\uFF01"), (false));
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
