...
public class YibangrenzhinangguiScreen extends AbstractContainerScreen<YibangrenzhinangguiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("primogemcraft:textures/screens/yibangrenzhinanggui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.primogemcraft.yibangrenzhinanggui.label_wu_pin_lan"), 80, 146, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.primogemcraft.yibangrenzhinanggui.label_jin_bu_qu_zhi_nang"), 9, 7, -12829636);
	}
