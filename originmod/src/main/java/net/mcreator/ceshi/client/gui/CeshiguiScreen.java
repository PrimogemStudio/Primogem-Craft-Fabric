...
public class CeshiguiScreen extends AbstractContainerScreen<CeshiguiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.primogemcraft.ceshigui.label_bao_xiang"), 7, 6, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.primogemcraft.ceshigui.label_wu_pin_lan"), 7, 73, -12829636);
	}
