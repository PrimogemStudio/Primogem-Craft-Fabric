...
public class MolalajitongScreen extends AbstractContainerScreen<MolalajitongMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.primogemcraft.molalajitong.label_wu_pin_lan"), 7, 124, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.primogemcraft.molalajitong.label_mo_la_zhi_la_ji_tong"), 6, 5, -12829636);
	}
