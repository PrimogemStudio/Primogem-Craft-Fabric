...
public class LiulangzhezhinangguiScreen extends AbstractContainerScreen<LiulangzhezhinangguiMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.primogemcraft.liulangzhezhinanggui.label_liu_lang_zhe_zhi_nang"), 7, 7, -12829636);
		this.font.draw(poseStack, new TranslatableComponent("gui.primogemcraft.liulangzhezhinanggui.label_wu_pin_lan"), 7, 59, -12829636);
	}
