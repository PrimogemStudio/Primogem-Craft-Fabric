...
public class SuijiqiwuScreen extends AbstractContainerScreen<SuijiqiwuMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.primogemcraft.suijiqiwu.label_sui_ji_qi_wu"), 6, 6, -12829636);
	}
	...
	public void init() {
		...
		button_shua_xin = new Button(this.leftPos + 73, this.topPos + 75, 35, 20, new TranslatableComponent("gui.primogemcraft.suijiqiwu.button_shua_xin"), e -> {
			if (true) {
