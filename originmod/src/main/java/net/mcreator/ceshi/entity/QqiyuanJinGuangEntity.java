...
public class QqiyuanJinGuangEntity extends PathfinderMob {
	public QqiyuanJinGuangEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PrimogemcraftModEntities.QQIYUAN_JIN_GUANG.get(), world);
	}
	...
	public QqiyuanJinGuangEntity(EntityType<QqiyuanJinGuangEntity> type, Level world) {
		...
		xpReward = 1;
		setNoAi(false);
		setCustomName(new TextComponent("右键出金！"));
