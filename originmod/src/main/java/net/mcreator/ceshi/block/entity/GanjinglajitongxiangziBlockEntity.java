...
public class GanjinglajitongxiangziBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return new TextComponent("ganjinglajitongxiangzi");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new GanjinglajitongMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
