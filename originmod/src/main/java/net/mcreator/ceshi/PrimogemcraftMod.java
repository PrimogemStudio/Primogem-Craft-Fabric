...
public class PrimogemcraftMod {
	...
	public PrimogemcraftMod() {
		PrimogemcraftModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		PrimogemcraftModBlocks.REGISTRY.register(bus);
		PrimogemcraftModItems.REGISTRY.register(bus);
		PrimogemcraftModEntities.REGISTRY.register(bus);
		PrimogemcraftModBlockEntities.REGISTRY.register(bus);
		PrimogemcraftModFeatures.REGISTRY.register(bus);

		PrimogemcraftModEnchantments.REGISTRY.register(bus);
		PrimogemcraftModMobEffects.REGISTRY.register(bus);
		PrimogemcraftModPotions.REGISTRY.register(bus);

		PrimogemcraftModParticleTypes.REGISTRY.register(bus);
	}
