...
public class Dibiaomola01Feature extends Feature<NoneFeatureConfiguration> {
	public static Dibiaomola01Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Dibiaomola01Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("primogemcraft:dibiaomola_01", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("primogemcraft:dibiaomola_01", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("primogemcraft", "xinmolayiji04"));
		if (template == null)
			return false;
