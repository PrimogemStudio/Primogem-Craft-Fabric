...
public class Xxiaoguanzi02Feature extends Feature<NoneFeatureConfiguration> {
	public static Xxiaoguanzi02Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Xxiaoguanzi02Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("primogemcraft:xxiaoguanzi_02", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("primogemcraft:xxiaoguanzi_02", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("primogemcraft", "xiaoguanzi02"));
		if (template == null)
			return false;
