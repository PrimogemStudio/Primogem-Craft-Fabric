...
public class Molayiji01Feature extends Feature<NoneFeatureConfiguration> {
	public static Molayiji01Feature FEATURE = null;
	public static Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> CONFIGURED_FEATURE = null;
	public static Holder<PlacedFeature> PLACED_FEATURE = null;

	public static Feature<?> feature() {
		FEATURE = new Molayiji01Feature();
		CONFIGURED_FEATURE = FeatureUtils.register("primogemcraft:molayiji_01", FEATURE, FeatureConfiguration.NONE);
		PLACED_FEATURE = PlacementUtils.register("primogemcraft:molayiji_01", CONFIGURED_FEATURE, List.of());
		return FEATURE;
	}
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		if (!generate_dimensions.contains(context.level().getLevel().dimension()))
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("primogemcraft", "molayiji101"));
		if (template == null)
			return false;
