...
public class SuijiqiwuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SuijiqiwuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PrimogemcraftModMenus.SUIJIQIWU, id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			PrimogemcraftMod.PACKET_HANDLER.sendToServer(new SuijiqiwuSlotMessage(slotid, x, y, z, ctype, meta));
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof SuijiqiwuMenu) {
