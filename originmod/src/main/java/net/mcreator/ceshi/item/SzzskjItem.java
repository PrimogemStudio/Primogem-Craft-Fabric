...
public abstract class SzzskjItem extends ArmorItem {
	public SzzskjItem(EquipmentSlot slot, Item.Properties properties) {
	...
	public static class Helmet extends SzzskjItem {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent("\u00A72\u5305\u542B\u5957\u88C5\u6570\u503C\uFF1A\u00A7e[1]"));
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "primogemcraft:textures/models/armor/szzt__layer_1.png";
		}
	...
	public static class Leggings extends SzzskjItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "primogemcraft:textures/models/armor/szzt__layer_2.png";
		}
