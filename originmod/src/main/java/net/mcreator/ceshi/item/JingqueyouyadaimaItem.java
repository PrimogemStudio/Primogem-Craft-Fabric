...
public class JingqueyouyadaimaItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A72\u751F\u7269\u83B7\u5F97\u901F\u5EA6\u7B49\u7EA7\u52A0\u6210"));
		list.add(new TextComponent("\u00A77\u4EE3\u7801\u4FEE\u590D\u540E\uFF1A"));
		list.add(new TextComponent("\u00A72\u51FB\u6740\u76EE\u6807\u540E\u6982\u7387\u63D0\u5347\u81EA\u8EAB\u901F\u5EA6\u7B49\u7EA7"));
		list.add(new TextComponent("\u00A72\u82E5\u901F\u5EA6\u6548\u679C\u5C0F\u4E8E10\u79D2\uFF0C\u5C06\u7EE7\u627F\u6301\u7EED\u65F6\u95F4"));
		list.add(new TextComponent("\u00A72\u5426\u5219\u53D6\u6301\u7EED\u65F6\u95F4\u768410%\u7EE7\u627F"));
