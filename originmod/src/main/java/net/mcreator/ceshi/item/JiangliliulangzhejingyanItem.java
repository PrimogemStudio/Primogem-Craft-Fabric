...
public class JiangliliulangzhejingyanItem extends Item {
	public JiangliliulangzhejingyanItem() {
		super(new Item.Properties().tab(PrimogemcraftModTabs.TAB_ZHENGHUO).durability(551).fireResistant().rarity(Rarity.COMMON));
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77\u53EF\u4EE5\u50A8\u5B58\u00A7b20\u00A7a\u7ECF\u9A8C\u7B49\u7EA7\u00A77\u7684\u00A7a\u7ECF\u9A8C\u503C\uFF01"));
