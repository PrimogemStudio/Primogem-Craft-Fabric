...
public class JjljxjhjItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77 - \u5927\u5927\u524A\u5F31\u76EE\u6807\u653B\u51FB\u4F24\u5BB3"));
		list.add(new TextComponent("\u00A77 - \u89E6\u53D1\u51E0\u7387100%"));
		list.add(new TextComponent("\u00A77 - \u5B58\u50A8\u7684\u89E6\u53D1\u6B21\u6570 10"));
		list.add(new TextComponent("\u00A77 - \u89E6\u53D1\u51B7\u53748\u79D2 \u6BCF\u6B21\u5355\u72EC\u8BA1\u7B97"));
		list.add(new TextComponent("\u00A77 - \u5355\u6B21\u89E6\u53D1\u6301\u7EED\u65F6\u95F4 10\u79D2"));
	}
}
