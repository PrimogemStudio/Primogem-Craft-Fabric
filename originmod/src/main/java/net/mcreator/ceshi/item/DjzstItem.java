...
public abstract class DjzstItem extends ArmorItem {
	public DjzstItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			@Override
			public int getDurabilityForSlot(EquipmentSlot slot) {
				return new int[]{13, 15, 16, 11}[slot.getIndex()] * 116;
			}
	...
	public static class Helmet extends DjzstItem {
		public Helmet() {
		...
		public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
			...
			list.add(new TextComponent("\u00A79\u5305\u542B\u5957\u88C5\u6570\u503C\uFF1A\u00A7e[1]"));
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "primogemcraft:textures/models/armor/djzst__layer_1.png";
		}
	...
	public static class Chestplate extends DjzstItem {
		public Chestplate() {
	...
	public static class Leggings extends DjzstItem {
		public Leggings() {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "primogemcraft:textures/models/armor/djzst__layer_2.png";
		}
	...
	public static class Boots extends DjzstItem {
		public Boots() {
