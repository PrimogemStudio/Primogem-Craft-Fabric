...
public class LiulangzhezhinangItem extends Item {
	public LiulangzhezhinangItem() {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77\u5B58\u50A8\u7A7A\u95F4\uFF1A18"));
	}
		...
		if (entity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openGui(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return new TextComponent("流浪者之囊");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					return new LiulangzhezhinangguiMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
