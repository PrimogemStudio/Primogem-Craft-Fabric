...
public class DayingxiongdejingyanItem extends Item {
	public DayingxiongdejingyanItem() {
		super(new Item.Properties().tab(PrimogemcraftModTabs.TAB_ZHENGHUO).durability(1396).fireResistant().rarity(Rarity.EPIC));
	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("\u00A77\u53EF\u4EE5\u50A8\u5B58\u00A7d30\u00A7a\u7ECF\u9A8C\u7B49\u7EA7\u00A77\u7684\u00A7a\u7ECF\u9A8C\u503C\uFF01"));
