...
public class BlockUtil {
    private static final List<Function<BlockPos, BlockPos>> airFindMaps = Lists.newArrayList(
            BlockPos::below, BlockPos::above, BlockPos::east, BlockPos::west, BlockPos::south, BlockPos::north
    );
