...
public class PrimogemCraftItems {
    ...
    public static final BlockItem VAJRADA_AMETHYST_ORE_BLOCK_ITEM = register("vajrada_amethyst_ore", new BlockItem(VAJARDA_AMETHYST_ORE_BLOCK, new Item.Properties()));
