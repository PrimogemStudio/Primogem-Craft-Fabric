...
public class PrimogemCraftCreativeTabs {
    ...
    public static void init() {
        ...
        Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, KEY_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1).title(Component.translatable("itemGroup.primogemcraft_blocks")).icon(() -> new ItemStack(PRIMOGEM_ORE)).displayItems((itemDisplayParameters, output) -> {
            output.accept(PRIMOGEM_ORE);
            output.accept(DEEP_SLATE_PRIMOGEM_ORE);
            output.accept(PRIMOGEM_BLOCK);
            output.accept(VAYUDA_TURQUOISE_GEMSTONE_ORE_BLOCK);
            output.accept(VAYUDA_TURQUOISE_GEMSTONE_BLOCK);
            output.accept(VAJRADA_AMETHYST_ORE_BLOCK);
            output.accept(VAJRADA_AMETHYST_BLOCK);
            output.accept(INTERTWINED_FATE_BLOCK);
            output.accept(DENDRO_CORE_BLOCK);
            output.accept(MORA_BUNCH_BLOCK);
            output.accept(MORA_BLOCK);
            output.accept(EXQUISITE_MORA_BLOCK);
            output.accept(CHEAP_MORA_BLOCK);
            output.accept(CHEAP_MORA_SLAB_BLOCK);
            output.accept(CHEAP_MORA_STAIR_BLOCK);
            output.accept(CHEAP_MORA_WALL_BLOCK);
            output.accept(TEYVAT_STICK_ITEM);
            output.accept(TEYVAT_PLANKS_BLOCK);
            output.accept(TEYVAT_PLANK_SLAB_BLOCK);
            output.accept(TEYVAT_PLANK_STAIR_BLOCK);
            output.accept(TEYVAT_PLANK_FENCE_BLOCK);
            output.accept(TEYVAT_PLANK_FENCE_GATE_BLOCK);
            output.accept(BLUE_TEYVAT_PLANKS_BLOCK);
            output.accept(BLUE_TEYVAT_PLANK_SLAB_BLOCK);
            output.accept(BLUE_TEYVAT_PLANK_STAIR_BLOCK);
            output.accept(BLUE_TEYVAT_PLANK_FENCE_BLOCK);
            output.accept(BLUE_TEYVAT_PLANK_FENCE_GATE_BLOCK);
            output.accept(PINK_TEYVAT_PLANKS_BLOCK);
            output.accept(PINK_TEYVAT_PLANK_SLAB_BLOCK);
            output.accept(PINK_TEYVAT_PLANK_STAIR_BLOCK);
            output.accept(PINK_TEYVAT_PLANK_FENCE_BLOCK);
            output.accept(PINK_TEYVAT_PLANK_FENCE_GATE_BLOCK);
            output.accept(CHAR_COAL_BLOCK);
            output.accept(RUSTED_PLANK_BLOCK);
            output.accept(RUSTED_PLANK_STAIR_BLOCK);
            output.accept(DENDRO_CORE_PLANKS_BLOCK);
            output.accept(DENDRO_CORE_PLANK_SLAB_BLOCK);
            output.accept(DENDRO_CORE_PLANK_STAIRS_BLOCK);
            output.accept(DENDRO_CORE_PLANK_FENCE_BLOCK);
            output.accept(DENDRO_CORE_PLANK_FENCE_GATE_BLOCK);
            output.accept(DENDRO_CORE_PLANK_PRESSURE_PLATE_BLOCK);
            output.accept(DENDRO_CORE_PLANK_BUTTON_BLOCK);
        }).build());
        ...
        Registry.register(BuiltInRegistries.CREATIVE_MODE_TAB, KEY_TOOLS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1).title(Component.translatable("itemGroup.primogemcraft_weapon_tools")).icon(() -> new ItemStack(DULL_BLADE_ITEM)).displayItems((itemDisplayParameters, output) -> {
            ...
            output.accept(VAJRADA_AMETHYST_HOE_ITEM);
            output.accept(VAJRADA_AMETHYST_AXE_ITEM);
            output.accept(VAJRADA_AMETHYST_PICKAXE_ITEM);
            output.accept(VAJRADA_AMETHYST_SHOVEL_ITEM);
        }).build());
    }
}