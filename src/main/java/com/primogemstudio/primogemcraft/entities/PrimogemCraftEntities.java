...
public class PrimogemCraftEntities {
    ...
    public static EntityType<GachaFourStarEntity> PURPLE_LIGHT;
    public static EntityType<GachaThreeStarEntity> BLUE_LIGHT;
    ...
    public static void init() {
        ...
        PURPLE_LIGHT = register("purple_light", EntityType.Builder.of(GachaFourStarEntity::new, MobCategory.MISC).noSave().sized(0.0f, 0.0f).clientTrackingRange(16).updateInterval(Integer.MAX_VALUE));
        BLUE_LIGHT = register("blue_light", EntityType.Builder.of(GachaThreeStarEntity::new, MobCategory.MISC).noSave().sized(0.0f, 0.0f).clientTrackingRange(16).updateInterval(Integer.MAX_VALUE));
