...
public class PrimogemCraftEntities {
    ...
    public static final EntityType<AcquaintFateEntity> ACQUAINT_FATE_ENTITY = register("acquaint_fate_entity", EntityType.Builder.<AcquaintFateEntity>of(AcquaintFateEntity::new, MobCategory.MISC).sized(0.25f, 0.25f).clientTrackingRange(4).updateInterval(10));
